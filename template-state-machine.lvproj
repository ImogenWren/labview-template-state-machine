	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="template-state-machine" Type="Folder">
			...
			<Item Name="ctl" Type="Folder">
				<Item Name="cDAQ-options.ctl" Type="VI" URL="../template-state-machine-iwh/cDAQ-options.ctl"/>
			...
			<Item Name="util" Type="Folder">
				<Item Name="decode-from-json-cDAQ.vi" Type="VI" URL="../template-state-machine-iwh/decode-from-json-cDAQ.vi"/>
				<Item Name="decode-from-json.vi" Type="VI" URL="../template-state-machine-iwh/decode-from-json.vi"/>
				<Item Name="encode-to-json-cdaq.vi" Type="VI" URL="../template-state-machine-iwh/encode-to-json-cdaq.vi"/>
			...
			<Item Name="template-state-machine-adam-iwh.vi" Type="VI" URL="../template-state-machine-iwh/template-state-machine-adam-iwh.vi"/>
			<Item Name="template-state-machine-cDAQ-AO.vi" Type="VI" URL="../template-state-machine-iwh/template-state-machine-cDAQ-AO.vi"/>
			<Item Name="template-state-machine-cDAQ-iwh.vi" Type="VI" URL="../template-state-machine-iwh/template-state-machine-cDAQ-iwh.vi"/>
		</Item>
